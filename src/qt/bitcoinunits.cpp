...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Bitfinites"));
    case mBTC: return QString(QObject::tr("Milli-Bitfinites (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Bitfinites (1 / 1,000,000)"));
    default: return QString("???");
    }
}
