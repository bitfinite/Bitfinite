...
static const char *strDNSSeed[][2] = {
	{"159.203.56.32", "159.203.56.32"},
	{"67.205.136.224", "67.205.136.224"},
	{"178.62.37.101", "178.62.37.101"}
...
void ThreadDNSAddressSeed(void* parg)
{
	...
	RenameThread("Bitfinite-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
	...
	RenameThread("Bitfinite-adrdump");
...
void ThreadOpenConnections(void* parg)
{
	...
	RenameThread("Bitfinite-opencon");
...
void ThreadMessageHandler(void* parg)
{
	...
	RenameThread("Bitfinite-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
	...
	if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
	{
		...
		if (nErr == WSAEADDRINUSE)
			strError = strprintf(_("Unable to bind to %s on this computer. Bitfinite is probably already running."), addrBind.ToString().c_str());
		else
